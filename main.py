...
class tk_master:
    ...
    def select_camera(self):
        ...
        def upload_files(event):
            tk_master.camera="Chathram"
            user_home_root.destroy()
            tt = tk_master
            tt.user_login(event)
        admin_id1 = canvas1.create_text(350, 170, text="Chathram", font=("Times New Roman", 28), fill=get_data.get_text_color())
        ...
        def upload_files2(event):
            tk_master.camera="Thillainagar"
            user_home_root.destroy()
            tt = tk_master
            tt.user_login(event)
        admin_id3 = canvas1.create_text(350, 290, text="Thillainagar", font=("Times New Roman", 28), fill=get_data.get_text_color())
